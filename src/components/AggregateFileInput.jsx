    ...
    return (<div>
        <label htmlFor="file-dropzone" className="flex flex-col justify-center items-center w-full bg-gray-100 rounded-xl border-2 py-3 border-gray-200 hover:cursor-pointer hover:bg-gray-200 hover:border-gray-300">
            {!file ? <>
                ...
                <p className="text-md font-semibold text-gray-600"><span className="text-blue-800 font-bold">Click to upload</span></p>
            </>
            : 
            <>
                <svg className="text-blue-800 aspect-square w-[18px] h-[18px] mb-2" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="text-md">Uploaded <span className="font-semibold text-blue-800">{file.name}</span></p>
            </>}
